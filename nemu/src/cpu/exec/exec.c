...
make_group(gp5,
    ...
    EX(jmp_rm), EMPTY, EX(push_rm), EMPTY)
...
make_EHelper(gp2) {
  switch (decoding.ext_opcode) {
    ...
    default: panic("bad ext_opcode %#x in group 2", decoding.ext_opcode);
  }
}
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	IDEX(r, push_r), IDEX(r, push_r), IDEX(r, push_r), IDEX(r, push_r),
  /* 0x54 */	IDEX(r, push_r), IDEX(r, push_r), IDEX(r, push_r), IDEX(r, push_r),
  /* 0x58 */	IDEX(r, pop_r), IDEX(r, pop_r), IDEX(r, pop_r), IDEX(r, pop_r),
  /* 0x5c */	IDEX(r, pop_r), IDEX(r, pop_r), IDEX(r, pop_r), IDEX(r, pop_r),
  ...
  /* 2-byte opcode table (opcodes with 0x0f prefix) */
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(movzx_Eb2G, movzx), IDEX(movzx_Ew2G, movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(movsx_Eb2G, movsx), IDEX(movsx_Ew2G, movsx),
